...
export default {
  ...
  methods: {
    toggleMenu() {
      this.$emit("toggle-menu", !this.isMenuOpen);
    },
  },
};
</script>
...
<template>
  <div
    @click="toggleMenu"
    id="hamburger"
    :class="isMenuOpen ? 'hamburglar is-open' : 'hamburglar is-closed'"
  >
...
$color: var(--clr-white); // icon color
$blue: var(--clr-highlight); // background color
$animation: 0.6s; // animation speed
$scale: 1; // icon scale 68/68
